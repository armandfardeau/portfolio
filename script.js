...
const formatCount = (count) => new Intl.NumberFormat('en', { notation: 'compact', maximumFractionDigits: 1 }).format(count);
...
async function loadGitHubMetadata() {
  try {
    ...
    // The static copy remains complete when GitHub is unavailable or rate-limited.
